...
test_data_folder_path = os.path.normpath(os.path.join(test_code_file_path, '../../Find Stop Line Nodes/test_data/'))
...
# E:\road_model_maker\src\proj_mgeo_editor_morai_opengl\GUI
...
class TestFindStopLineNodes:
    ...
    # @pytest.fixture
    # def expected_find_stop_line_nodes(self, expected_node_set):
    #     return ErrorFix.highlight_on_stop_line
