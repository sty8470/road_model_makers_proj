...
test_data_folder_path = os.path.normpath(os.path.join(test_code_file_path, '../../Find Short Links/test_data/'))
...
class TestFindShortLinks:
    ...
    @pytest.fixture
    def expected_find_short_links(self, expected_link_set):
        return ErrorFix.find_short_link(expected_link_set, self.link_dist_threshold)
    ...
    # 1
    def test_find_short_link(self, expected_link_set, expected_find_short_links):
        assert expected_link_set.lines == expected_find_short_links[0]
