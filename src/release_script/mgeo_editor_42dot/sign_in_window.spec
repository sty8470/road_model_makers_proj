...
mgeo_editor_path = os.path.abspath(os.path.join(src_path, 'proj_mgeo_editor_42dot'))
...
a = Analysis(['sign_in_window.py'],
             pathex=[current_path,
			   ...
			   os.path.abspath(os.path.join(lib_path, 'open_scenario')),
			   os.path.abspath(os.path.join(lib_path, 'open_scenario', 'client'))
             ],
             binaries=[],
             datas=[(os.path.join(mgeo_editor_path, 'GUI', '*.json'), './proj_mgeo_editor_42dot/GUI'),
