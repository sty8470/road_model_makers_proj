"""
vtkBooleanOperationPolyDataFilter를 사용해서 
박스1에서 박스2를 빼려고 해봤는데 안 됨
"""
...
if __name__ == '__main__':
    ...
    w = 50
    large = [ [c-w,c-w,t], [c+w,c-w,t], [c+w,c+w,t], [c-w,c+w,t] ] +\
        [ [c-w,c-w,0], [c+w,c-w,0], [c+w,c+w,0], [c-w,c+w,0] ]   

    w = 10
    t = 5
    small = [ [c-w,c-w,t], [c+w,c-w,t], [c+w,c+w,t], [c-w,c+w,t] ] +\
        [ [c-w,c-w,-t], [c+w,c-w,-t], [c+w,c+w,-t], [c-w,c+w,-t] ]   
    

    face_idx = [[0,1,2,3], [7,6,5,4], [1,0,4,5], [2,1,5,6], [3,2,6,7], [0,3,7,4]]
    large_obj = make_road(large, face_idx)
    small_obj = make_road(small, face_idx)
    

    # 데이터 처리를 위해 이 과정이 필요
    sphere1Tri = vtk.vtkTriangleFilter()
    sphere1Tri.SetInputData(large_obj)
    sphere2Tri = vtk.vtkTriangleFilter()
    sphere2Tri.SetInputData(small_obj)
    ...
    # booleanOperation.SetInputDataObject(0, large_obj)
    # booleanOperation.SetInputDataObject(1, small_obj)
    ...
    input1Mapper.SetInputData(large_obj)
    ...
    input2Mapper.SetInputData(small_obj)
    ...
    objExporter.SetFilePrefix('test_road_with_hole')
