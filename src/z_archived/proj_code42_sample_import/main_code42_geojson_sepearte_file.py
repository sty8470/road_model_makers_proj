...
def main():
    ...
    output_path = '../../output/geojson_code42/toGwacheonSample_seperate'
    relative_loc = True
    ...
    for i in range(len(surf_line_list)):
        ...
        if kind_str == 'Lane_Border' or kind_str == 'Lane_Center':
            ...
            if not (type_name in type_name_list):
                ...
                output_file_name = output_file_name_prefix + type_name
                output_file_name_list[type_name] = output_file_name
                output_file_current_num[type_name] = 0
    ...
    for i in range(len(surf_line_list)):
        ...
        fileOpenMode = 'w'
        output_file_current_num[key] += 1
        each_out = output_file_name_list[key] + '{:04d}.csv'.format(output_file_current_num[key])
